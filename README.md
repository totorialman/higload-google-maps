...
| **place**           | Описывает места (название, описание, рейтинг, контакты, категория и т. д.)                       | 663                  | 250M                           | 154 GB  |
...
| **node**            | Представляет географические точки (широта, долгота)                                              | 48                   | 9B                            | 402 GB  |
| **node_tag**        | Дополнительные атрибуты узлов (например, название улицы, высота и т. д.)                         | 232                  | 906M                           | 196 GB  |
| **way**             | Объединяет узлы в линии (например, дороги, реки)                                                 | 16                   | 1B                             | 15 GB   |
...
| **way_tag**         | Хранит дополнительные атрибуты путей                                                             | 232                  | 2,5M                          | 553 MB  |
| **relation**        | Определяет сложные связи между объектами (например, маршруты, границы)                           | 16                   | 13M                           | 198 MB  |
| **relation_tag**    | Дополнительные свойства для связей                                                               | 232                  | 53M                            | 11.5 GB |
...
| **tile_cache**      | Информация о кэше                                                                                | 44                   | 1.6B                            | 65.6 GB |
...
| **review**   | **R:** Информация о местах `34.8K × 5 отзывов = 174K`<br/>**W:** Пользователи оставляют ~2 млн отзывов в день → **~23 RPS**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | 174K     | 23        |
