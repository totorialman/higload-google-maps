...
<img width="3257" height="1324" alt="Mermaid Chart - Create complex, visual diagrams with text -2025-10-16-093118" src="https://github.com/user-attachments/assets/8cb09b44-0e00-44d3-a6f4-b239d1c509b2" />
...
| ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------- | --------- |
| **user**     | Минимальные данные об авторах отзывов. Полные профили хранятся в Google Accounts. <br/>**R:** При получении **информации о местах** (69.6K RPS) подгружаются отзывы и данные пользователей: `69.6K × 5 = 348K QPS`.<br/>**W:** Добавление записей только при создании новых отзывов (`review`).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 348K     | —         |
| **place**    | Хранит основные сведения о местах (POI). <br/>**R:** Информация о местах + Поиск мест = `69.6K + 49.5K = 119.1K`.<br/>**W:** Пользовательские правки редки, глобально ~2 RPS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | 119.1K   | 2         |
| **category** | Категории мест. Изменяются редко, читаются при запросах информации и поиска.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | 119.1K   | 0         |
| **review**   | Отзывы пользователей. <br/>**R:** Информация о местах `69.6K × 5 отзывов = 348K QPS`.<br/>**W:** ~2 млн отзывов в день → **~23 RPS**.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | 348K     | 23        |
| **map_version** | Метаданные версий карт при редактировании. Создаётся при каждой правке.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | —        | 2         |
...
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------- |
| `node`, `node_tag`, `way`, `way_node`, `relation`, `relation_tag`, `relation_member`, `member_type` | (`69.6K`) Информация о местах + <br>(`49.5K`) Поиск мест + <br>(`27K`) Маршруты + <br>(`166.7K`) Навигация = **~312.8K QPS**                                                  | 2         |
...
- Для таблиц `node`, `node_tag`, `way`, `way_node`, `relation`, `relation_tag`, `relation_member`, `member_type` будем использовать 16 реплик на чтение. Воспользуемся каскадной репликацией, чтобы избежать нагрузки на master.
