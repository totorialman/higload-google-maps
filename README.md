...
#### Хранение тайлов
Сами бинарные файлы тайлов (.webp, .pbf) не хранятся в базе данных, а размещаются во внешнем объектном хранилище - Google Cloud Storage (GCS).
Объём данных: ~1.7 млрд тайлов × 600 Б ≈ 1 ТБ
